...
require "charakku/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "charakku"
  s.version     = Charakku::VERSION
  s.authors     = ["kpvarma"]
  s.email       = ["krshnaprsad@gmail.com"]
  s.homepage    = "https://github.com/right-solutions/charakku"
  s.summary     = "Charakku is a Merchandise Application"
  s.description = "Inventory Management, Warehouse / Store Management, POS Module"
  s.license     = "MIT"
